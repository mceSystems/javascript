...
## Strings
  ...
  - [6.4](#strings--eval) Never use `eval()` on a string, it opens too many vulnerabilities. If you think you need it - ask your supervisor. 
...
## Functions
  ...
  - [7.12](#functions--mutate-params) Avoid mutating parameters. In case it's intentional, make sure it's well documented and understood. eslint: [`no-param-reassign`](http://eslint.org/docs/rules/no-param-reassign.html)
...
## Arrow Functions
  ...
  - [8.2](#arrows--implicit-return) Never omit braces, even if the function body consists of a single expression. Always use a return expression. eslint: [`arrow-parens`](http://eslint.org/docs/rules/arrow-parens.html), [`arrow-body-style`](http://eslint.org/docs/rules/arrow-body-style.html) jscs:  [`disallowParenthesesAroundArrowParam`](http://jscs.info/rule/disallowParenthesesAroundArrowParam), [`requireShorthandArrowFunctions`](http://jscs.info/rule/requireShorthandArrowFunctions)

    > Why? Avoid confusion and errors when adding new statements.
